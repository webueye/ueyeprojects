<link rel="stylesheet" href="${pageContext.request.contextPath}/css/div_css.css" type="text/css"></link>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/blueTheme.css" type="text/css"></link>
