...
<html>
	...
	<form>
			...
			<tr>
				<th colspan="4" class="th">
					<div align=right style="margin-right:10px;">
						<a href="${pageContext.request.contextPath}/user-group-role/${id }/edit">
							编辑列表
						</a>
					</div>
				</th>
		...
		<c:forEach var="role" items="${page.data}">
			<tr>
				...
				<td>
					<a href="${pageContext.request.contextPath}/user-group-role/${role.id }?userGroup.id=${id }&_method=delete">
