...
<html>
	...
	<form name="userGroup" action="${pageContext.request.contextPath}/user-group/${userGroup.id }" method="post">
		...
		<table class="table" width="70%" cellSpacing="1" cellPadding="4">
			<tr class="th">
				...
				<td class="ltd">
					...
					<input type="text" size="15" name="userGroup.groupName" value="${userGroup.groupName }" readonly="readonly"/>
				</td>
			</tr>
			<tr class="th">
